...
<section class="section bg">
    <div class="container">
        <div class="column is-6 is-offset-3">
            <div class="box">
                <h3 class="title is-size-2 has-text-centered">Registrarse</h3>
                <form action="check/registro.php" method="post">
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="number" name="edad" placeholder="Edad" required>
                            <span class="icon is-small is-left">
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="text" name="sexo" placeholder="Sexo" required>
                            <span class="icon is-small is-left">
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="text" name="nacionalidad" placeholder="Nacionalidad" required>
                            <span class="icon is-small is-left">
                    ...
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="text" name="rut_npas" placeholder="Rut o Número de Pasaporte" required>
                            <span class="icon is-small is-left">
