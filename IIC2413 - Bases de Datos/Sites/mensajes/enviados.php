...
<section class="hero is-danger">
    <div class="hero-body">
        ...
        <h2 class="subtitle has-text-centered">En esta sección puedes revisar los mensajes que has enviado a otros usuarios</h2>
    </div>
</section>
...
<div class="tabs is-centered">
    <ul>
        ...
        <li class="is-active"><a href="enviados.php">Mensajes enviados</a></li>
...
<?php if (empty($sent_messages)) {?>
    <h3 class="has-text-centered">No has enviado ningún mensaje</h3>
<?php } else { ?>
    <div class="columns">
