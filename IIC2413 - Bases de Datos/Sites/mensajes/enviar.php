...
<section class="hero is-danger">
    <div class="hero-body">
        ...
        <h2 class="subtitle has-text-centered">En esta sección puedes enviar mensajes a otros usuarios</h2>
    </div>
</section>
...
<div class="tabs is-centered">
    <ul>
        <li class="is-active"><a href="enviar.php">Enviar mensaje</a></li>
...
<div class="container">
    <div class="column is-6 is-offset-3">
        <div class="box">
            <form action="../check/enviar_mensaje.php" method="post">
                <div class="field">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea" name="message" placeholder="Mensaje"></textarea>
                    </div>
                </div>

                <div class="field is-grouped is-grouped-centered">
                    <div class="control">
                        <input class="button is-primary" type="submit" value="Enviar mensaje"> 
                    </div>
                </div>
            </form>
        </div>
